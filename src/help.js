...
❑ .ytmp4 ❑
Função: baixa vídeos do YouTube
Como Usar: Envie .ytmp4 + link do vídeo

📷 COMANDO PARA IMAGENS 📷
...
❑ .resizevid ❑
Função: Converte e redimensiona gifs e vídeos
...
❑ .blacklist ❑
Função: Mostra todos os números que não pode usar o BOT
Como Usar: Envie .blacklist
...
❑ .ocr ❑
Função: Envia pra você o texto de uma imagem
Como Usar: Envie uma imagem e escreva na legenda o comando .ocr
...
Como Usar: .setprefix [text|optional] 
Exemplo: .setprefix ?
...
❑ .addpalavra ❑
Função: Adiciona palavra proibida no grupo
Como Usar: .addpalavra + a palavra

❑ .rmpalavra ❑
Função: Remove palavra proibida
Como Usar: .rmpalavra + a palavra que está proibida
